...
class VehicleRoutingConstraintProviderTest {
    ...
    void vehicleCapacityUnpenalized() {
        Vehicle vehicleA = new Vehicle(1L, 100, new Depot(1L, location1), 0);
        Customer customer1 = new Customer(2L, location2, 80, 1, 0, 1000000);
    ...
    void vehicleCapacityPenalized() {
        ...
        Customer customer2 = new Customer(3L, location3, 40, 1, 0, 1000000);
