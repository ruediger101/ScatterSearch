...
public class VehicleRoutingConstraintProvider implements ConstraintProvider {
        ...
        public Constraint[] defineConstraints(ConstraintFactory factory) {
                return new Constraint[] {
                                ...
                                vehicleInUse(factory),
                                arrivalAfterEndOfServiceWindow(factory),
                };
        }
        ...
        protected Constraint arrivalAfterEndOfServiceWindow(ConstraintFactory factory) {
                return factory.forEach(Vehicle.class)
                                .penalizeLong(HardSoftLongScore.ONE_HARD,
                                                Vehicle::getNoServiceTimeViolations)
                                .asConstraint("arrivalAfterEndOfServiceWindow");
        }
}
